...
class City:
    def __init__(self, name, lat, lon):
      ...
      self.lon = lon
    def __str__(self):
      return f'{self.name} at lat {self.lat} and lon {self.lon}'
...
# Had to turn lat and lng to floats to pass test
...
# Pseudocode
# If city lat is in range of lat 1 and lat 2
# and city lon is in range of lon 1 and lon 2
# add to within
